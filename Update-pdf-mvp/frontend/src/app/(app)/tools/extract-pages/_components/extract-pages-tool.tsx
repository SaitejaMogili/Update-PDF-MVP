...
import { FileText, Upload, Loader2, Download, CheckCircle, FileOutput } from "lucide-react";
  ...
  if (phase === "done" && downloadUrl) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm">
        ...
        <h2 className="mb-6 text-lg font-bold text-slate-900">Pages extracted!</h2>
  ...
  if (phase === "processing" || phase === "uploading") {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-10 text-center shadow-sm">
        ...
        <p className="font-semibold text-slate-900">{phase === "uploading" ? "Uploading…" : "Extracting pages…"}</p>
      </div>
    );
  }
      ...
      {file && phase === "idle" && (
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="px-5 py-5">
            <label className="mb-1 block text-xs font-semibold text-slate-700">Pages to extract</label>
            <input
            ...
            />
            <p className="mt-1 text-[11px] text-slate-400">Comma-separated. Use ranges like 5-8.</p>
          </div>
